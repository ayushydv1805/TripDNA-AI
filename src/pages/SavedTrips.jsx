      ...
      <main className="mx-auto max-w-6xl px-6 py-12">
        <header className="mb-10">
          ...
          <p className="mt-3 text-slate-300">
            Your most recent trip searches are stored locally in this browser.
          </p>
        </header>
        ...
        {trips.length === 0 ? (
          <section className="rounded-3xl border border-white/10 bg-white/5 p-10 text-center backdrop-blur-xl">
            ...
            <p className="mt-2 text-slate-400">
              Search for a route to automatically save it here.
            </p>
          </section>
        ) : (
            ...
            {trips.map((trip, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="mt-5 rounded-lg bg-red-600 px-4 py-2 font-semibold transition hover:bg-red-500"
                >
                  🗑 Delete
                </button>
              </article>
