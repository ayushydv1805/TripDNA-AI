      ...
      <main className="mx-auto max-w-5xl px-6 py-12">
        <section className="rounded-3xl border border-white/10 bg-white/5 p-8 md:p-10 backdrop-blur-xl">
          <div className="flex flex-col gap-6 md:flex-row md:items-center">
            <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-cyan-400/10 text-4xl border border-cyan-300/20">
              👤
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-slate-300">
                Your TripDNA activity is stored locally in this browser.
              </p>
            </div>
          </div>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2">
            <Link
              to="/saved"
              className="rounded-2xl border border-white/10 bg-white/5 p-6 transition hover:-translate-y-1 hover:border-cyan-300/30"
            >
            ...
            <Link
              to="/favorites"
              className="rounded-2xl border border-white/10 bg-white/5 p-6 transition hover:-translate-y-1 hover:border-pink-300/30"
            >
              <p className="text-3xl">❤️</p>
