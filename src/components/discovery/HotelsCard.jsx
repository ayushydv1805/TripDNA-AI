    ...
    <section className="bg-slate-800 rounded-xl p-6 my-6">
      ...
      <div className="grid md:grid-cols-2 gap-5">
        {hotels.map((hotel, index) => {
          ...
          return (
            <article key={hotel.id || [name, address, index].join("-")} className="bg-slate-900 rounded-xl p-5 shadow-lg">
              ...
              <div className="flex flex-wrap gap-3 mt-5">
                ...
                <button
                  type="button"
                  onClick={() => saveFavorite({ type: "Hotel", name, address, lat, lon, id: hotel.id })}
